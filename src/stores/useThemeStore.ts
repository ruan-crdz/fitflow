...
export const THEMES: AppTheme[] = [
  ...
  { id: 'blue', name: 'Azul', icon: 'water_drop', colors: { primary: '#3b82f6', primaryLight: '#60a5fa', primaryDark: '#1d4ed8', bg: '#0a0f1a', bgCard: '#141e30', accent: '#3b82f6' } },
  ...
  { id: 'orange', name: 'Laranja', icon: 'local_fire_department', colors: { primary: '#f97316', primaryLight: '#fb923c', primaryDark: '#c2410c', bg: '#1a120a', bgCard: '#2d1e14', accent: '#f97316' } },
  ...
  { id: 'hello-kitty', name: 'Hello Kitty', icon: 'styler', colors: { primary: '#ff69b4', primaryLight: '#ffb6c1', primaryDark: '#ff1493', bg: '#2d0a1a', bgCard: '#3d1530', accent: '#ff69b4' }, font: "'Quicksand', sans-serif", special: true, wallpaper: '/fitflow/assets/wallpaper-hello-kitty.jpg' },
  { id: 'harry-potter', name: 'Harry Potter', icon: 'bolt', colors: { primary: '#d4a017', primaryLight: '#f0c040', primaryDark: '#8b6914', bg: '#1a150a', bgCard: '#2d2510', accent: '#740001' }, font: "'Cinzel', serif", special: true, wallpaper: '/fitflow/assets/wallpaper-harry-potter.jpg' },
];
