...
export const EXERCISE_CATALOG: CatalogExercise[] = [
  ...
  // Costas
  { name: 'Graviton', muscleGroup: 'Costas', image: img('Full_Range-Of-Motion_Lat_Pulldown') },
  { name: 'Remada Curvada', muscleGroup: 'Costas', image: img('Bent_Over_Barbell_Row') },
  { name: 'Remada Unilateral', muscleGroup: 'Costas', image: img('One-Arm_Dumbbell_Row') },
  { name: 'Puxada Aberta', muscleGroup: 'Costas', image: img('Wide-Grip_Lat_Pulldown') },
  { name: 'Puxada Fechada', muscleGroup: 'Costas', image: img('Close-Grip_Front_Lat_Pulldown') },
  { name: 'Remada Sentada', muscleGroup: 'Costas', image: img('Seated_Cable_Rows') },
  ...
  // Bíceps
  { name: 'Rosca Direta', muscleGroup: 'Bíceps', image: img('Barbell_Curl') },
  { name: 'Rosca Alternada', muscleGroup: 'Bíceps', image: img('Dumbbell_Alternate_Bicep_Curl') },
  ...
  { name: 'Rosca Corda', muscleGroup: 'Bíceps', image: img('Cable_Hammer_Curls_-_Rope_Attachment') },
  ...
  // Tríceps
  { name: 'Tríceps no Cabo', muscleGroup: 'Tríceps', image: img('Triceps_Pushdown') },
  ...
  // Peitoral
  { name: 'Supino Reto', muscleGroup: 'Peitoral', image: img('Barbell_Bench_Press_-_Medium_Grip') },
  { name: 'Supino Inclinado', muscleGroup: 'Peitoral', image: img('Incline_Dumbbell_Press') },
  { name: 'Supino com Halteres', muscleGroup: 'Peitoral', image: img('Dumbbell_Bench_Press') },
  { name: 'Crucifixo', muscleGroup: 'Peitoral', image: img('Dumbbell_Flyes') },
  { name: 'Crossover', muscleGroup: 'Peitoral', image: img('Cable_Crossover') },
  ...
  // Ombros
  { name: 'Desenvolvimento', muscleGroup: 'Ombros', image: img('Dumbbell_Shoulder_Press') },
  ...
  { name: 'Crucifixo Inverso', muscleGroup: 'Ombros', image: img('Cable_Rear_Delt_Fly') },
  { name: 'Elevação Lateral Sentada', muscleGroup: 'Ombros', image: img('Seated_Side_Lateral_Raise') },

  // Quadríceps
  { name: 'Agachamento', muscleGroup: 'Quadríceps', image: img('Barbell_Squat') },
  ...
  { name: 'Hack', muscleGroup: 'Quadríceps', image: img('Hack_Squat') },
  { name: 'Afundo', muscleGroup: 'Quadríceps', image: img('Dumbbell_Lunges') },
  { name: 'Agachamento Búlgaro', muscleGroup: 'Quadríceps', image: img('Dumbbell_Rear_Lunge') },
  { name: 'Agachamento com Halter', muscleGroup: 'Quadríceps', image: img('Goblet_Squat') },
  ...
  { name: 'Stiff', muscleGroup: 'Posterior de Coxa', image: img('Stiff-Legged_Barbell_Deadlift') },
  { name: 'Stiff com Halteres', muscleGroup: 'Posterior de Coxa', image: img('Stiff-Legged_Dumbbell_Deadlift') },
  { name: 'Stiff Romeno', muscleGroup: 'Posterior de Coxa', image: img('Romanian_Deadlift') },
  { name: 'Bom Dia', muscleGroup: 'Posterior de Coxa', image: img('Good_Morning') },

  // Glúteos
  { name: 'Elevação Pélvica', muscleGroup: 'Glúteos', image: img('Barbell_Hip_Thrust') },
  { name: 'Ponte de Glúteos', muscleGroup: 'Glúteos', image: img('Barbell_Glute_Bridge') },
  { name: 'Glúteo na Polia', muscleGroup: 'Glúteos', image: img('One-Legged_Cable_Kickback') },
  { name: 'Ponte Unilateral', muscleGroup: 'Glúteos', image: img('Single_Leg_Glute_Bridge') },
  { name: 'Cadeira Abdutora', muscleGroup: 'Glúteos', image: img('Thigh_Abductor') },
  { name: 'Cadeira Adutora', muscleGroup: 'Glúteos', image: img('Thigh_Adductor') },
  ...
  // Cardio
  { name: 'Esteira - Caminhada/Corrida', muscleGroup: 'Cardio', image: img('Running_Treadmill') },
  { name: 'Esteira - Trote', muscleGroup: 'Cardio', image: img('Jogging_Treadmill') },
  { name: 'Elíptico', muscleGroup: 'Cardio', image: img('Elliptical_Trainer') },
  { name: 'Bicicleta', muscleGroup: 'Cardio', image: img('Bicycling_Stationary') },
  { name: 'Bicicleta Reclinada', muscleGroup: 'Cardio', image: img('Recumbent_Bike') },
  { name: 'Remo Indoor', muscleGroup: 'Cardio', image: img('Rowing_Stationary') },
  { name: 'Escada', muscleGroup: 'Cardio', image: img('Stairmaster') },
  { name: 'Corda', muscleGroup: 'Cardio', image: img('Rope_Jumping') },
];
