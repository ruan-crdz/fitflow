import{u as ce,a as le,e as me,r as d,S as de,w as pe,j as e,A as ue,m as j,M as xe}from"./index-CYROSrGN.js";import{E as G}from"./exerciseCatalog-CPEt03Po.js";import{a as fe}from"./ai-RPrRLmE3.js";import{g as ve,b as ge}from"./evidence-ChQtjloK.js";import{A as he}from"./aiSchemas-BbNQ6iSo.js";import{v as Ae}from"./planValidator-CHmjkKvn.js";import"./calories-vWo9U0uR.js";import"./water-BSM1bDNo.js";function Ie(){const x=ce(),a=le(o=>o.profile),{setApiKey:V,apiKey:h}=me(),[A,$]=d.useState(h?"generating":"token"),[N,U]=d.useState(""),[k,I]=d.useState(""),[S,X]=d.useState([]),[w,W]=d.useState([]),f=a.trainingDays.length||3,T=a.goal==="lose"?"perder gordura":a.goal==="gain"?"ganhar massa muscular":"manter peso",D=a.experienceLevel==="advanced"?"avançado":a.experienceLevel==="intermediate"?"intermediário":"iniciante";d.useEffect(()=>{h&&A==="generating"&&b(h)},[]);const H=async()=>{const o=N.trim();if(!o.startsWith("sk-")){I('Token inválido. Deve começar com "sk-"');return}I(""),V(o),$("generating"),await b(o)},J=()=>{x("/plans")},s=o=>{X(i=>[...i,o])},[K,O]=d.useState(0),[R,v]=d.useState(!1),b=async o=>{var M,q,B;v(!1),S.length===0&&(s(`Olá, ${a.name}! `),await p(800),s(`Vi que você treina ${f}x por semana e é ${D}. Deixa eu avaliar a melhor estratégia de divisão pra você...`),await p(1200),s(`Seu objetivo é ${T}. Vou adaptar volume e seleção de exercícios ao seu contexto real de treino.`),await p(1e3),s("Avaliando opções de split (Full Body, Upper/Lower, ABC, ABCD, ABCDE)... "));const i={};for(const r of G)(i[M=r.muscleGroup]??(i[M]=[])).push(r.name);const y=Object.entries(i).map(([r,t])=>`${r}: ${t.join(", ")}`).join(`
